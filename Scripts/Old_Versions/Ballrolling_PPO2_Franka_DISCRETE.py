...
from Ballrolling_FrankaGymEnvironment_ContinuousActions import CustomEnv
...
model = PPO2(policy, env, learning_rate=my_learning_rate, verbose=1, 
             tensorboard_log="/media/ryuga/TOSHIBA EXT/BA/TensorBoardLogs/COMPARE_FRANKA_BALLROLL_RYZEN")  # defaults: learning_rate=2.5e-4,
