...
class Car():
    def __init__ (self, x_pos = 50.0, y_pos = 50.0, rotation = 0, rotation_step_size = 0.01745*5, maxspeed = 1.0, borderless = False, acceleration = 0.1):
        """[summary]
...
class Render:
    ...
    def __init__ (self, object2DList):
        ...
        self.window1.setCoords(0, 0, 1000, 1000)
