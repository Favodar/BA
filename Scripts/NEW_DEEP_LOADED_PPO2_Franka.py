...
from NEW_FrankaGymEnvironment_DiscreteActions_Crashsafe import CustomEnv
...
# my_learning_rate = 0.00025 #scheduler.value  # 0.0005
...
# name = filename
name = "PHYSTEST002_CD6_LI100_LoadedFrom270kSteps_Phys002_ppo2_franka_discrete_LR_" + print_LR + "_timesteps_" + \
...
while(i <= (timesteps/10000)):
    model.learn(total_timesteps=10000, tb_log_name=name, log_interval=100, reset_num_timesteps=False)
