...
class RosControlAdapter():
    ...
    def run_step(self, dt):
        ...
        if math.fmod(dt, self.__time_step) < 1e-10:
            ...
            print("Advancing simulation is deactivated because class couldnt be imported, see the line of code below this one as well as the imported classes at the top of this script")
