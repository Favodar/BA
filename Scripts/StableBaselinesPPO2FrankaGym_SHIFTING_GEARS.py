...
timesteps = 5000
model = PPO2(MlpPolicy, env, learning_rate= my_learning_rate, verbose=1, tensorboard_log="/home/fritz/Documents/TensorBoardLogs") # defaults: learning_rate=2.5e-4,
model.learn(total_timesteps= timesteps)

name = "ppo2_franka_SHIFTING_GEARS_learning_rate_" + str(my_learning_rate) + "_sps_" + str(sps) + "_timesteps_" + str(timesteps)
